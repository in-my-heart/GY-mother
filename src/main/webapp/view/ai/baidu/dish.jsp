...
var prefix = "<%=basePath%>";
 ...
 function load() {
	$('#exampleTable').bootstrapTable({
				...
				url : prefix + "bdicr/listDish", // 服务器数据的加载地址
				iconSize : 'outline',
				...
				columns : [
					...
					},
					{
						...
						formatter:function (value,row,index) {
							var values='.'+value;
							var a = '<img title="菜品名称:'+row.dishName+'" class="faceimage" src="'+values+'" width="66px" height="66px" onerror="this.src=\'./image/loadfail.png\'">';
							return a;
                        }						
					},{
						field : 'dishName',
		...
		layer.confirm("确认要删除选中的'" + rows.length + "'条数据吗?",{btn : [ '确定', '取消' ]
			...
			$.each(rows, function(i, row) {
					...
					$.ajax({
						...
						url : prefix + 'bdicr/batchRemoveDish',
						success : function(r) {
							if (r.code == 0) {
